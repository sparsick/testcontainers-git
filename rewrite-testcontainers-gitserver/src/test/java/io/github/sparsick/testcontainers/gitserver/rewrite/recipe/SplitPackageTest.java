...
public class SplitPackageTest implements RewriteTest {
  ...
  public void defaults(RecipeSpec spec) {
    spec.recipe(
        SplitPackageTest.class.getResourceAsStream("/META-INF/rewrite/rewrite.yml"),
        "io.github.sparsick.testcontainers.gitserver.rewrite.recipe.SplitPackage");
    spec.parser(
        JavaParser.fromJavaVersion()
            .classpathFromResources(
                new InMemoryExecutionContext(), "testcontainers-gitserver-0.4.0"));
  }
